...
- (void)scrollToPage:(NSUInteger)pageNumber animated:(BOOL)animated{
    if (pageNumber < _pageCount) {
        ...
        switch (self.orientation) {
            case NewPagedFlowViewOrientationHorizontal:
                [_scrollView setContentOffset:CGPointMake(_pageSize.width * (pageNumber + self.orginPageCount), 0) animated:animated];
                break;
            case NewPagedFlowViewOrientationVertical:
                [_scrollView setContentOffset:CGPointMake(0, _pageSize.height * (pageNumber + self.orginPageCount)) animated:animated];
                break;
        }
